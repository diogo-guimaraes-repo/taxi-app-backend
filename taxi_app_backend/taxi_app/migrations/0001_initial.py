# Generated by Django 3.2.5 on 2021-12-24 15:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('CLIENT', 'Client'), ('DRIVER', 'Driver'), ('ADMIN', 'Admin')], default='CLIENT', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='taxi_app.client')),
                ('driver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='taxi_app.driver')),
                ('payment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='taxi_app.payment')),
            ],
        ),
        migrations.CreateModel(
            name='Admin',
